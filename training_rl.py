...
class ScriptArguments:
    ...
    output_dir: Optional[str] = field(default="output-checkpoint/llama2_rl_ppo_128_8_8_1.4e-5_adam", metadata={"help": "n steps to save the model"})
...
train_dataset = load_dataset("", data_dir="data/rl", split="train")
